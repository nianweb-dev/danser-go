...
func initRecording() *recording {
	return &recording{
		...
		H264V4L2Settings: &h264V4L2Settings{
			RateControl:       "vbr",
			Bitrate:           "10M",
			AdditionalOptions: "",
		},
...
type recording struct {
	...
	H264V4L2Settings    *h264V4L2Settings  `json:"h264_v4l2m2m" label:"Video4Linux2 Encoder H.264 (AVC) Settings" showif:"Encoder=h264_v4l2m2m"`
